<?php
  ...
  if(isset($_POST['login-submit'])) {
    ...
    // If the email is not registered 
      ...
      alert("Ne postoji Urednik sa ovim imejlom !");
      redirect('./login.php');
    }
  }
...
<head>
  ...
  <title>News Portal Admin Panel | Prijava</title>
...
<body>
  <header id="header">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center"><a href="../index.php" style="text-decoration: none; color: inherit;">News Portal</a> <small>Urednik Prijava</small></h1>
        </div>
      </div>
    </div>
  </header>
        ...
        <div class="col-md-4 col-md-offset-4">
          <form id="login" method="POST" class="well">
            <div class="form-group">
              ...
              <input type="email" class="form-control" placeholder="Unesi email..." name="login-email" />
            </div>
            <div class="form-group">
              <label>Lozinka</label>
              <input type="password" class="form-control" placeholder="Lozinka" name="login-password" />
            </div>
