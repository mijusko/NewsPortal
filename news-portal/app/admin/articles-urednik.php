...
function deleteConfirm(id) {
  if (confirm("Da li ste sigurni da zelite da obrisete ovu vest ?")) {
...
<section id="breadcrumb">
  <div class="container">
    <ol class="breadcrumb">
      <li><a href="./urednik.php">Pocetni Panel</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <tr>
              <th style="min-width: 70px">Pregled</th>
              <th style="min-width: 170px">Naslov</th>
              <th style="min-width: 100px">Kategorije</th>
              <th style="min-width: 250px">Sadrzaj</th>
              <th style="min-width: 90px">Slika</th>
              <th style="min-width: 120px">Autor</th>
              <th style="min-width: 100px">Datum Objave</th>
                ...
                if($row > 0) {
                  while($data = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                      <tr>
                      <td>
                          <a class="btn btn-primary" href="./article-preview.php?id='.$article_id.'" title="Preview Article">
          ...
          <ul class="pagination pg-red">
            <?php
              ...
              if(mysqli_num_rows($paginationResult) > 0) {
                ...
                if($page > $total_page) {
                  redirect('./articles-urednik.php');
                }
                if($page > 1) {
                  echo '
                    <li class="page-item">
                      <a href="articles-urednik.php?page='.($page - 1).'" class="page-link">
                        <span>&laquo;</span>
                      </a>
                    </li>';
                }
                for($i = 1; $i <= $total_page; $i++) {
                  ...
                  echo '<li class="page-item '.$active.'"><a href="./articles-urednik.php?page='.$i.'" class="page-link">'.$i.'</a></li>';
                }
                if($total_page > $page){
                  echo '
                    <li class="page-item">
