...
function deleteConfirm(id) {
  if (confirm("Da li ste sigurno da zelite da podnesete zahtev za brisanje ?")) {
...
<section id="main">
  <div class="container">
    <div class="col-md-12">
      <?php
       $limit = 10; // Promenite vrednost limita na željeni broj
       ...
       $sql = "SELECT article.article_title, 
               ...
               ORDER BY article.article_date DESC, article.article_id DESC
               LIMIT {$offset}, {$limit}";
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-striped table-hover article-table">
            <tr>
              <th style="min-width: 200px">Naslov</th>
              <th style="min-width: 120px">Kategorija</th>
              <th style="min-width: 250px">Tekst</th>
              <th style="min-width: 90px">Slika</th>
              <th style="min-width: 50px">Aktivnost</th>
              <th style="min-width: 130px">Datum Objave</th>
...
<script>
function checkArticleActive(articleId, $article_active) {
  if ($article_active == 1) {
    alert('Article is Active. You cannot edit an active article.');
  } else {
