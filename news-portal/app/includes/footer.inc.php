  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        ...
        <a style="background-color:#ff7300;" href="./author-login.php" class="my-1 btn btn-secondary">Registruj se</a>
      </ul>
    </li>
  </ul>
  <div class="footer-bottom">
    <p>Mihajlo Jankovic &copy; News Portal <?php echo date("Y")?></p>
  </div>
</footer>
