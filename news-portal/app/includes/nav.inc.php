...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>News Portal | Vesti | <?php echo $page_title; ?></title>
...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="ul">
      ...
      <li><a href="./index.php" <?php if($home) echo 'class="current"' ?>>Pocetna</a></li>
      <li>
        <label for="btn-1" class="show">Kategorije +</label>
        <a href="./categories.php" <?php if($category) echo 'class="current"' ?>>Kategorije</a>
        ...
        <ul>
          ...
          ?>
          <li><a href="./categories.php">Jos +</a></li>
        </ul>
      </li>
      <li><a href="./bookmarks.php" <?php if($bookmark) echo 'class="current"' ?>>Oznacene</a></li>
      <?php
      ...
      <li>
        ...
        <a href="./user-login.php" <?php if($login) echo 'class="current"' ?>>Prijavi se</a>
        <input type="checkbox" id="btn-2" class="input" />
        <ul>
          <li><a href="./user-login.php">Citalac</a></li>
          <li><a href="./author-login.php">Novinar</a></li>
        </ul>
      </li>
      <?php
        }
      ...
      <?php
        ...
        if(isset($_SESSION['USER_NAME'])) {
          echo '
          <li>
            <label for="btn-2" class="show">Podesavanja</label>
            <a href="#"';
          ...
          echo
            ...
            <input type="checkbox" id="btn-2" class="input" />
            <ul>
              <li><a href="./user-change-password.php">Promeni Lozinku</a></li>
              <li><a href="./logout.php">Odjavi se</a></li>
              </ul>
          </li>
          ';
          echo '<li><a disabled> '.$_SESSION["USER_NAME"].' </a></li>';
        }
      ?>
    </ul>
  </nav>